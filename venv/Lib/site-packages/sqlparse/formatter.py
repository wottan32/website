...
def validate_options(options):
    ...
    if truncate_strings is not None:
        ...
        options['truncate_char'] = options.get()

    indent_columns = options.get()
    ...
    indent_after_first = options.get()
